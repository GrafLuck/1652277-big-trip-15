...
export default class Sorting extends AbstractView {
  constructor() {
    super();
    this._sortInputChangeHandler = this._sortInputChangeHandler.bind(this);
  }
  ...
  setSortInputChangeHandler(callback) {
    this._callback.sortInputChange = callback;
    this.getElement().addEventListener('change', this._sortInputChangeHandler);
  }

  _sortInputChangeHandler(evt) {
    evt.preventDefault();
    this._callback.sortInputChange(evt.target.dataset.sortType);
  }
}
